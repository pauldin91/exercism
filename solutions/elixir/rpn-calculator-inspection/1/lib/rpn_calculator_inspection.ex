defmodule RPNCalculatorInspection do
  # Start a linked process that runs the calculator on input
  def start_reliability_check(calculator, input) do
    {:ok, pid} = Task.start_link(fn -> calculator.(input) end)
    %{input: input, pid: pid}
  end

  # Wait for the spawned process to send a result
  ...
  # Run reliability check for a list of inputs
  ...
  # Run correctness check synchronously
